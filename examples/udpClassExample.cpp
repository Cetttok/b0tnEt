#include <iostream>
#include "udpworker.h"
//пример обмена сообщениями с помощью UdpWorker
using namespace std;
const int SERVER_PORT = 1234; // порт на котором работает сервер
const int CLIENT_PORT = 4321; // порт на котором работает клиент
